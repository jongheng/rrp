...
class TestDescription(models.Model):
    ...
    total_number_zone = models.CharField(max_length=300, verbose_name='Total Numbser Of Zones')
    total_number_ticker_zone = models.CharField(max_length=300, verbose_name='Total Numbser Of Ticker Zones')
    total_number_widget_zone = models.CharField(max_length=300, verbose_name='Total Numbser Of Widget Zones')
    total_number_html_zone = models.CharField(max_length=300, verbose_name='Total Numbser Of Html Zones')
